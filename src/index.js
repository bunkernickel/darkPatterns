...
import './index.css';
import HW1Light from './Routes/HW1/HW1Light.js'
import HW1Dark from './Routes/HW1/HW1Dark.js'
import HW2Light from './Routes/HW2/HW2Light.js'
import HW2Dark from './Routes/HW2/HW2Dark.js'
import HW3Light from './Routes/HW3/HW3Light.js'
import HW3Dark from './Routes/HW3/HW3Dark.js'
import HW4Light from './Routes/HW4/HW4Light.js'
import HW4Dark from './Routes/HW4/HW4Dark.js'
 

const termsText = `Privacy Policy for Cobs Cobblers
English
Privacy Policy
    ...
    render(){
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/HW1Light" element={<HW1Light pattern="light" text={giveText()}/>}/>   
          <Route path="/HW1Dark" element={<HW1Dark pattern="dark" text={giveText()}/>}/>
          <Route path="/HW2Light" element={<HW2Light pattern="light" text={giveText()}/>}/>  
          <Route path="/HW2Dark" element={<HW2Dark pattern="dark" text={giveText()}/>}/>   
          <Route path="/HW3Light" element={<HW3Light pattern="light" text={giveText()}/>}/>
          <Route path="/HW3Dark" element={<HW3Dark pattern="dark" text={giveText()}/>}/>
          <Route path="/HW4Light" element={<HW4Light pattern="light" text={giveText()}/>}/>
          <Route path="/HW4Dark" element={<HW4Dark pattern="dark" text={giveText()}/>}/>
        </Routes>
      </BrowserRouter>,
      this.state
      );
